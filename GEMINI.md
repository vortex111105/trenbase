...
# Website Design Recreation (Visual Diffing Workflow)
...
2. **Screenshot** the rendered page using Puppeteer (`npx puppeteer screenshot index.html --fullpage` or equivalent) or the native browser subagent. If the page has distinct sections, capture those individually too.
